...
for name in os.listdir(f"{ROOT_DIR}/referencewavs/"):
...
def change_wav(audio_path):
    ...
    return f"{ROOT_DIR}/referencewavs/{audio_path}",text
...
def main():
    with gr.Blocks() as demo:
        ...
        gr.Markdown("#### 请输入需要合成的文本，选择推理模式，并按照提示步骤进行操作。请注意新的音色名称不要包含中文")
    ...
    demo.launch(server_name='0.0.0.0', server_port=args.port, ssl_certfile="/home/dl/package/nginx-1.22.0_10004/conf/ssl/wss.pem", ssl_keyfile="/home/dl/package/nginx-1.22.0_10004/conf/ssl/wss.key", ssl_verify=False)
